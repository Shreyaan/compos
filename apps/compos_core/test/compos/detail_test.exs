defmodule Compos.DetailTest do
  @moduledoc "The Scheme detail-window tests, in this daemon: they rearrange windows, so never in the live one."
  use ExUnit.Case
  ...
  @file_ Path.join([:code.priv_dir(:compos_core), "tests", "detail-test.scm"])
  ...
  @tag timeout: 120_000
  test "detail-test.scm passes", %{frame: frame} do
