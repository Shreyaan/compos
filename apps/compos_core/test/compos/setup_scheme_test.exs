defmodule Compos.SetupSchemeTest do
  @moduledoc """
  Runs priv/tests/setup-test.scm alone: first-run setup policy, the connector
  scan, and the provider bootstrap.
  """
  ...
  @file_ Path.join([:code.priv_dir(:compos_core), "tests", "setup-test.scm"])
