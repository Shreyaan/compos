defmodule Compos.ImenuSchemeTest do
  @moduledoc """
  Runs priv/tests/imenu-test.scm alone: the outline index and the prompt's preview.
  """
  ...
  @file_ Path.join([:code.priv_dir(:compos_core), "tests", "imenu-test.scm"])
