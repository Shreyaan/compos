...
| a-broadened-switcher-lists-every-buffer-under-two-headings, a-heading-takes-no-selection-and-no-count, a-refresh-keeps-a-non-selected-window-on-its-row, a-switch-to-a-member-takes-the-selected-window, active-target-persists-without-a-group-switch, an-agents-edit-keeps-a-peeked-file, autolayout-mode-re-arranges-when-a-window-comes, background-buffer-context-does-not-grow-a-target-layout, explicit-main-selection-replaces-the-previous-target, fixed-target-underfills-and-grows-without-placeholder-panes, group-switch-restores-its-own-target, ibuffer-puts-the-frames-group-first, killing-a-visible-group-buffer-never-shows-a-foreign-buffer, overview-locks-the-frame-and-quit-restores, switching-context-removes-foreign-panes-from-a-saved-layout, target-candidates-exclude-foreign-transient-and-background-only-buffers, target-reflows-after-pane-close-without-reopening-hidden-work, the-modal-switcher-lists-the-same-sections-as-the-prompt, three-columns-outside-a-group-fill-from-the-buffer-mru | layouts and target layouts, red at HEAD 73c34f57 in a worktree run while the other session works on layouts. Bisected 2026-09-19: layout-policy 8 red at 66d2ea54 (its own last commit's day), group-switch 2 red at 66d2ea54 and 5 at 8f859bba (the agent commit that moved category foreign from the popup to the window chain), 6 at f6ad9f51, 9 at 0a3bfa57; detail 2 red at b5123dce and the third only behind them. None went red under the simplification; make-frame! (two names) is restored |
